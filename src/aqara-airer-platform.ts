...
import {AqaraAirerLight} from "./light-accessory";
import {AqaraAirerUpDown} from "./up-down-accessory";
import {AqaraConnector} from "./aqara-connector";

const PLATFORM_NAME = "aqara-airer-lite";
...
export = (api: API) => {
  ...
  api.registerPlatform(PLATFORM_NAME, AqaraAirerPlatform);
};

class AqaraAirerPlatform implements StaticPlatformPlugin {
